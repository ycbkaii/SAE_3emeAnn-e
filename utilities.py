...
def getBooksById(listIdBooks) :
    ...
    for id in listIdBooks : 
        ...
        queryToSelectBooks = f"SELECT DISTINCT(title), average_rating, nom_genre, isbn, cover_link, id FROM masterbook._livre NATURAL JOIN masterbook._genres_du_livre NATURAL JOIN masterbook._genre WHERE id_livre = {id};"
