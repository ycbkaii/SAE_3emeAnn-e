...
raw_csv = pd.read_csv("bigboss_book.csv")
...
awards_unique[['id_award', 'nom_awards']].to_csv("awards.csv", index=False, header=False)
recompense_en.to_csv("recompense_en.csv", index=False, header=False)
